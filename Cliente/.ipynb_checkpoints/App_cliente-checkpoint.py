...
def file_json_send():
    ...
    path_medellin = "Cliente/DB/50001.parquet"#data['path_medellin']
    path_customers = "Cliente/DB/customers.parquet" #data['path_customers']
    path_employees = "Cliente/DB/employees.parquet"#data['path_employees']
